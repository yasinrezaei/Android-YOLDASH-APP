...
public class HardBox extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        configureView();
        leveltext.setText("سطح سخت");
        mydb=new DatabaseHelper(getApplicationContext());
        Cursor res=mydb.getAllHardBox();
        if(res.getCount()==0){
        ...
        adapter=new BoxAdapter(getApplicationContext(),boxInfoList,0);
