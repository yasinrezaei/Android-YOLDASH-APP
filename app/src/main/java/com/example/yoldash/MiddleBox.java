...
public class MiddleBox extends AppCompatActivity {
    TextView leveltext;
    DatabaseHelper mydb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        configureView();
        leveltext.setText("سطح متوسط");

        mydb=new DatabaseHelper(getApplicationContext());
        Cursor res=mydb.getAllMiddleBox();
        if(res.getCount()==0){
        ...
        adapter=new BoxAdapter(getApplicationContext(),boxInfoList,1);
